...
const { auth, adminOnly, counselorOrAdmin } = require('../middleware/auth');
...
// @desc    Get all students (Counselor and Admin)
// @access  Private/Counselor/Admin
router.get('/students', [auth, counselorOrAdmin], async (req, res) => {
  try {
